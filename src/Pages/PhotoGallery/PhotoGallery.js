             ...
             <div className="position-relative">
                ...
                <div className='news-div-overlay position-absolute top-0 start-0 end-0 bottom-0 d-flex align-items-center justify-content-center'>
                    <div class="page-title-wrapper">
                        <h1 class="page-title text-light" data-content-field="title">Photo Gallery</h1>
                        <br/> 
                        <div class="page-desc" data-content-field="description"><p>Centrally located hotel in the heart of Kathmandu with a quiet and family friendly atmosphere</p></div>
                        </div>
                    </div>
                  </div>
